...
**🚀 MssqlConfigScout** est un projet développé par **Ayi NEDJIMI Consultants**, expert en cybersécurité et intelligence artificielle.
...
```bash
git clone https://github.com/VOTRE_USERNAME/MssqlConfigScout.git
cd MssqlConfigScout
```
